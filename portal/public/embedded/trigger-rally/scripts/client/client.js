...
`;
      ...
      constructor(scene) {
        ...
        this.uniforms = {
          ...
          tMap: {
            value: THREE.ImageUtils.loadTexture(window.BASE_PATH + '/embedded/trigger-rally/a/textures/dust.png')
          }
        };
  ...
  return TriggerClient = (function() {
    TriggerClient = class TriggerClient {
      ...
      constructor(containerEl, root, options) {
        ...
        this.audio.loadBuffer('/embedded/trigger-rally/a/sounds/checkpoint.ogg', buffer => { return this.checkpointBuffer = buffer; });
        this.kachingBuffer = null;
        this.audio.loadBuffer('/embedded/trigger-rally/a/sounds/kaching.ogg', buffer => { return this.kachingBuffer = buffer; });
        this.voiceBuffer = null;
        this.audio.loadBuffer('/embedded/trigger-rally/a/sounds/voice.ogg', buffer => {
